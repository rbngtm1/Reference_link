...
stage('deployment'){
        ...
        sh "scp -o StrictHostKeyChecking=no /home/ec2-user/workspace/pipeline-project/addressbook_main/target/addressbook.war ec2-user@54.173.243.85:/home/ec2-user/tomcat/webapp"
