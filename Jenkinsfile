...
publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: 'output/', reportFiles: 'index.html', reportName: 'HTML Report', reportTitles: 'surefire-report.html'])
